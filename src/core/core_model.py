...
_dirty_imports_model = {
    'KERNEL32.dll': {
        ...
        'IsDebuggerPresent': {'status': 5, 'message': 'Import often flagged for sandbox / analysis evasion'},
        ...
        'QueryPerformanceCounter': {'status': 4, 'message': 'Import often flagged for sandbox / analysis evasion'},
        ...
        'GetModuleHandleW': {'status': 4, 'message': 'Import often flagged for dynamic function location'},
        'OpenProcess': {'status': 4, 'message': 'Import often flagged for dynamic function location'},
        'WriteProcessMemory': {'status': 4, 'message': 'Import often flagged for dynamic function location'},
        ...
        'GetTickCount': {'status': 4, 'message': 'Import often flagged for sandbox / analysis evasion'},
        'Sleep': {'status': 4, 'message': 'Import often flagged for sandbox / analysis evasion'},
